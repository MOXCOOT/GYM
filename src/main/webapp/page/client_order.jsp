                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="client/person/message.jsp" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../person/modification" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>修改信息</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="client/shop/equipment.jsp" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>租借器材</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="client/shop/venue.jsp" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>租借场地</p>
                                </a>
                            </li>
